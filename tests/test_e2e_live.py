...
def test_e2e_live_navigation():
    with sync_playwright() as p:
        ...
        try:
            page.wait_for_selector('button:has-text("Sign In to Watchtower")', timeout=5000)
        ...
        page.wait_for_selector('[data-testid="stSidebar"]', state='attached', timeout=15000)
