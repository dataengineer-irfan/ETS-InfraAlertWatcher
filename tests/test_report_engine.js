...
eq("fmtDays today", E.fmtDays(0), "0d left");
eq("fmtDays days", E.fmtDays(23), "23d left");
eq("fmtDays months", E.fmtDays(400), "13m 10d left");
eq("fmtDays years", E.fmtDays(1095), "36m 15d left");
eq("fmtDays overdue", E.fmtDays(-5), "5d overdue");
eq("fmtDays long overdue compresses", E.fmtDays(-2068), "68m 28d overdue");
