...
def csv_download_button(
    ...
    return (
        ...
        f'display:inline-flex;align-items:center;justify-content:center;gap:4px;width:100%;height:30px;'
        f'box-sizing:border-box;border-radius:2px;background-color:#212429;color:#cbd5e1;'
        f'border:1px solid #2c3235;font-family:var(--font, -apple-system, BlinkMacSystemFont, \'Segoe UI\', sans-serif);'
        f'font-size:10.5px;font-weight:700;letter-spacing:0.02em;text-decoration:none;cursor:pointer;padding:0 6px;margin:0;'
        f'white-space:nowrap;overflow:hidden;text-overflow:ellipsis;'
        f'transition:background-color 0.15s ease,border-color 0.15s ease,color 0.15s ease;user-select:none;" '
        f'onmouseover="this.style.backgroundColor=\'rgba(56,189,248,0.15)\';this.style.borderColor=\'#38bdf8\';this.style.color=\'#ffffff\';" '
        f'onmouseout="this.style.backgroundColor=\'#212429\';this.style.borderColor=\'#2c3235\';this.style.color=\'#cbd5e1\';" '
